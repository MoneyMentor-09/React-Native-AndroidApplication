...
When you are ready to switch back to real AI:

1. Uncomment this import at the top:
   import { supabase } from "./supabase";

2. You can keep buildTransactionContext() and use it to send app data
   to your backend AI function.

3. Add this function back in and have your chat widget call
   askFinanceAssistant(question) instead of getHelpResponse(question).
...
4. In HelpChatWidget.tsx, switch:
   getHelpResponse(question)
   back to:
